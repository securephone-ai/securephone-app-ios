...
open class GalleryViewController: UIPageViewController, ItemControllerDelegate {
    ...
    fileprivate var closeLayout = ButtonLayout.pinRight(16, 16)
    fileprivate var seeAllCloseLayout = ButtonLayout.pinRight(16, 16)
    fileprivate var thumbnailsLayout = ButtonLayout.pinLeft(16, 16)
    fileprivate var deleteLayout = ButtonLayout.pinRight(16, 66)
