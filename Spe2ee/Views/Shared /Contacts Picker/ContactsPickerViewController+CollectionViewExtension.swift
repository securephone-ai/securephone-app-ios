...
extension ContactsPickerViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
    return self.selectedItems.count
  }
  
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ContactsPickerHeaderCollectionCell.ID,
                                                  for: indexPath as IndexPath) as! ContactsPickerHeaderCollectionCell
  ...
  {
    return CGSize(width: CGFloat(ContactsPickerConfig.selectorStyle.selectionHeight),
                  height: CGFloat(ContactsPickerConfig.selectorStyle.selectionHeight))
  }
