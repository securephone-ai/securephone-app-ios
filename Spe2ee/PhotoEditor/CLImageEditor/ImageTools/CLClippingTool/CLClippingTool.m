...
- (void)setup
{
  ...
  _menuScroll.clipsToBounds = TRUE;
  ...
  _menuContainer.transform = CGAffineTransformMakeTranslation(0, -_menuScroll.top);
...
- (void)cleanup
{
  ...
  [UIView animateWithDuration:kCLImageToolAnimationDuration
                   animations:^{
    self->_menuContainer.transform = CGAffineTransformMakeTranslation(0, -self->_menuScroll.top);
  }
