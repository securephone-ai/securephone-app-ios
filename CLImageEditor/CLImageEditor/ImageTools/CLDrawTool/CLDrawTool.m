...
- (void)setup
{
    ...
    _menuView.transform = CGAffineTransformMakeTranslation(0, -_menuView.top);
...
- (void)cleanup
{
    ...
    [UIView animateWithDuration:kCLImageToolAnimationDuration
                     animations:^{
                         self->_menuView.transform = CGAffineTransformMakeTranslation(0, -self->_menuView.top);
                     }
