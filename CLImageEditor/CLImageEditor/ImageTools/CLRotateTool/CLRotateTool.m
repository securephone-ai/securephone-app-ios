...
- (void)setup
{
    ...
    _rotateSlider.superview.center = CGPointMake(self.editor.view.width/2, self.editor.menuView.bottom + 15);
    ...
    _menuScroll.transform = CGAffineTransformMakeTranslation(0, -_menuScroll.top);
...
- (void)cleanup
{
    ...
    [UIView animateWithDuration:kCLImageToolAnimationDuration
                     animations:^{
                         self->_menuScroll.transform = CGAffineTransformMakeTranslation(0, -self->_menuScroll.top);
